...
export default function Mesat() {
    ...
    return (
        <>
            ...
            <div className="relative flex w-screen box-border bg-custom-background grid grid-cols-3 pb-5 md:pb-28">
                <motion.div
            ...
            <div className="relative flex w-screen box-border bg-custom-background grid grid-cols-5 md:grid-cols-3 pb-5 md:pb-28">
                <motion.div
            ...
            <div className="relative flex w-screen box-border bg-custom-background grid grid-cols-5 pl-5 md:pl-32 pb-5 md:pb-28">
            ...
            <div className="relative flex w-screen box-border bg-custom-background grid grid-cols-2">
                <motion.div
                    className="relative"
                    variants={fadeIn('down', 0.5)} initial="hidden" animate="show" exit='hidden'
                >
