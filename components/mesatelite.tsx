...
export default function CarouselCava() {
    ...
    return (
        <>
            ...
            < div className="relative w-screen h-screen grid grid-cols-1 md:grid-cols-2 md:gap-x-10 lg:gap-x-10 box-boder px-12 md:px-20 py-10 bg-custom-background" >
                <motion.div
            ...
            <div className="relative flex w-screen h-screen grid grid-cols-1 md:grid-cols-4 md:gap-x-10 md:pr-20  m-0 bg-custom-background">
                <motion.div
            ...
            <div className="relative flex items-end justify-center w-screen grid grid-cols-1 md:grid-cols-7 md:gap-x-10 md:py-10 pl-12 m-0 bg-custom-background">
                <motion.div
