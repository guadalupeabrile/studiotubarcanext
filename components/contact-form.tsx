...
const ContactForm = () => {
    ...
    return (
        ...
        <div className="w-screen h-screen bg-custom-background flex items-center flex-col">
            ...
            <div className="pt-10 md:w-1/3">
                <form ref={form} onSubmit={handleSubmit} className="flex flex-col items-center w-screen md:w-full px-5 ">
                    <Input
                        error={!!errors.name}
